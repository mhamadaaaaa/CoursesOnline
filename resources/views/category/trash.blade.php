...
{{-- {{route('ctg.trash')}} --}}
<div class="mb-5">
    <a href="{{route('category.index')}}" class="btn btn-sm btn-outline-success mr-2" style="margin-left: 30px">Backe</a>
    ...
    <table id="example2" class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{route('category.forcedeleate',[$item->id])}}" method="post">
                        @csrf
                        {{-- <input type="hidden" name="_method" value="delete"> --}}
                        @method('delete')
