...
<div class="card-body">
    ...
    <a href="{{route('course.create')}}" class="btn btn-sm btn-outline-success mr-2" style="margin-left: 30px">create</a>
    <table id="example2" class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{route('video.index')}}"class="btn btn-sm btn-outline-success mr-2" >video</a></td>
            </tr>
            @empty
                <tr calspan='7'>
                    no categ defind
